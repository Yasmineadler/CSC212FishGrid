...
public class FishGame {
	...
	public void click(int x, int y) {
		...
		if (world.canSwim(player, x, y) == false) {
			if ((atPoint.get(0).getClass().getSimpleName()) != "Snail" ) {
				System.out.println(atPoint.get(0).getClass().getSimpleName());
